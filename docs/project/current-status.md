...
**Technical stack:** Accepted in [ADR-0002](../decisions/0002-application-architecture-and-stack.md), with authentication revised by [ADR-0003](../decisions/0003-cost-and-auth-architecture-review.md). The frontend foundation and canonical experiences through the fixture-backed Invite Vendor drawer are implemented; backend/auth integrations are not.
...
- The three remaining canonical experiences (08–10), later onboarding steps, and functional backend workflows
